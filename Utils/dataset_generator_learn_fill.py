...
OBJECT_TYPES = ['kettle', 'winebottle', 'bottle', 'cup', 'pot', 'wateringcan', 'bowl', 'houseplant', 'mug']
...
if __name__ == "__main__":
    ...
    all_obj_goals = " ".join([f'(or (and (supervised_filled_{obj_type}) (supervised_notfilled_{obj_type}) ) (forall (?o1 - {obj_type}) (and (filled ?o1) (manipulated ?o1) (scanned ?o1)) ) )'
    ...
    with open(os.path.join('../Datasets','test_set_learn_fill.json'), 'w') as f:
